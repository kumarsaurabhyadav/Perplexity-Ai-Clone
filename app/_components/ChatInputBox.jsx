...
import { ArrowRight, Atom, AudioLines, Cpu, Globe, Mic, Paperclip, SearchCheck, Loader2 } from 'lucide-react'
            ...
            <div className='p-2 w-full max-w-2xl border rounded-2xl mt-10'>
                ...
                <div className='flex justify-between  items-end '>
                    ...
                    <div className='flex gap-4 items-center'>
                        ...
                        <Button onClick={onSearchQuery} disabled={!userSearchInput || loading}>
                          {loading
